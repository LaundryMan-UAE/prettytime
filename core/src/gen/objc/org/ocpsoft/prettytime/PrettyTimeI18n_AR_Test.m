...
//  source: /Users/marcussmith/HambroPerks/myforks/prettytime/core/src/test/java/org/ocpsoft/prettytime/PrettyTimeI18n_AR_Test.java
//
...
#include "org/ocpsoft/prettytime/PrettyTimeI18n_AR_Test.h"
#include "org/ocpsoft/prettytime/TimeUnit.h"
#include "org/ocpsoft/prettytime/format/SimpleTimeFormat.h"

@implementation OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test

- (void)setUp {
  locale_ = [[JavaUtilLocale alloc] initWithNSString:@"ar"];
...
- (void)testCeilingInterval {
  ...
  [OrgJunitAssert assertEqualsWithId:@"1 \u0634\u0647\u0631 \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:then]];
}

- (void)testNullDate {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] init];
  JavaUtilDate *date = nil;
  [OrgJunitAssert assertEqualsWithId:@"\u0628\u0639\u062f \u0644\u062d\u0638\u0627\u062a" withId:[t formatWithJavaUtilDate:date]];
}

- (void)testRightNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] init];
  [OrgJunitAssert assertEqualsWithId:@"\u0628\u0639\u062f \u0644\u062d\u0638\u0627\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] init]]];
}
...
- (void)testRightNowVariance {
  ...
  [OrgJunitAssert assertEqualsWithId:@"\u0628\u0639\u062f \u0644\u062d\u0638\u0627\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:600]]];
}

- (void)testMinutesFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"12 \u062f\u0642\u0627\u0626\u0642 \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 12]]];
}

- (void)testHoursFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0633\u0627\u0639\u0627\u062a \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 60 * 3]]];
}

- (void)testDaysFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0627\u064a\u0627\u0645 \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 60 * 24 * 3]]];
}

- (void)testWeeksFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0623\u0633\u0627\u0628\u064a\u0639 \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 60 * 24 * 7 * 3]]];
}

- (void)testMonthsFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0623\u0634\u0647\u0631 \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:2629743830LL * 3LL]]];
}

- (void)testYearsFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0633\u0646\u0648\u0627\u062a \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:2629743830LL * 12LL * 3LL]]];
}

- (void)testDecadesFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0639\u0642\u0648\u062f \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:315569259747LL * 3LL]]];
}

- (void)testCenturiesFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  [OrgJunitAssert assertEqualsWithId:@"3 \u0642\u0631\u0648\u0646 \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:3155692597470LL * 3LL]]];
}
...
- (void)testMomentsAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"\u0645\u0646\u0630 \u0644\u062d\u0638\u0627\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testMinutesAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"12 \u062f\u0642\u0627\u0626\u0642 \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testHoursAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0633\u0627\u0639\u0627\u062a \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testDaysAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0627\u064a\u0627\u0645 \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testWeeksAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0623\u0633\u0627\u0628\u064a\u0639 \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testMonthsAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0623\u0634\u0647\u0631 \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}

- (void)testCustomFormat {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]];
  id<OrgOcpsoftPrettytimeTimeUnit> unit = [[OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test_$1 alloc] init];
  (void) [t clearUnits];
...
- (void)testYearsAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0633\u0646\u0648\u0627\u062a \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testDecadesAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0639\u0642\u0648\u062f \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testCenturiesAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0642\u0631\u0648\u0646 \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}

- (void)testWithinTwoHoursRounding {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] init];
  [OrgJunitAssert assertEqualsWithId:@"2 \u0633\u0627\u0639\u0627\u062a \u0645\u0636\u062a" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:[((JavaUtilDate *) [[JavaUtilDate alloc] init]) getTime] - 6543990]]];
}
...
- (void)testFormattingDurationListInThePast {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0627\u064a\u0627\u0645 15 \u0633\u0627\u0639\u0627\u062a 38 \u062f\u0642\u0627\u0626\u0642 \u0645\u0636\u062a" withId:[t formatWithJavaUtilList:durations]];
}
...
- (void)testFormattingDurationListInTheFuture {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3 \u0627\u064a\u0627\u0645 15 \u0633\u0627\u0639\u0627\u062a 38 \u062f\u0642\u0627\u0626\u0642 \u0645\u0646 \u0627\u0644\u0622\u0646" withId:[t formatWithJavaUtilList:durations]];
}
...
- (void)copyAllFieldsTo:(OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test *)other {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test = { "PrettyTimeI18n_AR_Test", "org.ocpsoft.prettytime", NULL, 0x1, 31, methods, 2, fields, 0, NULL};
  return &_OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test;
}

@end

@implementation OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test_$1
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test_$1 = { "$1", "org.ocpsoft.prettytime", "PrettyTimeI18n_AR_Test", 0x8000, 3, methods, 0, NULL, 0, NULL};
  return &_OrgOcpsoftPrettytimePrettyTimeI18n_AR_Test_$1;
}
