...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(formatWithOrgOcpsoftPrettytimeDuration:withBoolean:);
  methods[6].selector = @selector(applyPatternWithNSString:withNSString:withLong:);
  methods[7].selector = @selector(getPatternWithLong:);
  methods[8].selector = @selector(getPattern);
  methods[9].selector = @selector(getQuantityWithOrgOcpsoftPrettytimeDuration:withBoolean:);
  methods[10].selector = @selector(getGramaticallyCorrectNameWithOrgOcpsoftPrettytimeDuration:withBoolean:);
  methods[11].selector = @selector(getSignWithOrgOcpsoftPrettytimeDuration:);
  methods[12].selector = @selector(getSingularNameWithOrgOcpsoftPrettytimeDuration:);
  methods[13].selector = @selector(getPluralNameWithOrgOcpsoftPrettytimeDuration:);
  methods[14].selector = @selector(setPatternWithNSString:);
  methods[15].selector = @selector(setFuturePrefixWithNSString:);
  methods[16].selector = @selector(setFutureSuffixWithNSString:);
  methods[17].selector = @selector(setPastPrefixWithNSString:);
  methods[18].selector = @selector(setPastSuffixWithNSString:);
  methods[19].selector = @selector(setRoundingToleranceWithInt:);
  methods[20].selector = @selector(setSingularNameWithNSString:);
  methods[21].selector = @selector(setPluralNameWithNSString:);
  methods[22].selector = @selector(setFutureSingularNameWithNSString:);
  methods[23].selector = @selector(setFuturePluralNameWithNSString:);
  methods[24].selector = @selector(setPastSingularNameWithNSString:);
  methods[25].selector = @selector(setPastPluralNameWithNSString:);
