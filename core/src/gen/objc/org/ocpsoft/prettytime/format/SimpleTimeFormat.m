...
static NSString *OrgOcpsoftPrettytimeFormatSimpleTimeFormat_NEGATIVE_ = @"-";
...
NSString *OrgOcpsoftPrettytimeFormatSimpleTimeFormat_applyPatternWithNSString_withNSString_withLong_(OrgOcpsoftPrettytimeFormatSimpleTimeFormat *self, NSString *sign, NSString *unit, jlong quantity) {
  ...
  result = [((NSString *) nil_chk(result)) replaceAll:OrgOcpsoftPrettytimeFormatSimpleTimeFormat_QUANTITY_ withReplacement:NSString_valueOfLong_(quantity)];
