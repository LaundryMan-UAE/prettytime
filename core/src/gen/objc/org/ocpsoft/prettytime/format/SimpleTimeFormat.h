...
inline NSString *OrgOcpsoftPrettytimeFormatSimpleTimeFormat_get_SIGN(void);
...
inline NSString *OrgOcpsoftPrettytimeFormatSimpleTimeFormat_get_QUANTITY(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
inline NSString *OrgOcpsoftPrettytimeFormatSimpleTimeFormat_get_UNIT(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT OrgOcpsoftPrettytimeFormatSimpleTimeFormat *new_OrgOcpsoftPrettytimeFormatSimpleTimeFormat_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgOcpsoftPrettytimeFormatSimpleTimeFormat *create_OrgOcpsoftPrettytimeFormatSimpleTimeFormat_init(void);
