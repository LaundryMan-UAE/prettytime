...
//  source: /Users/marcussmith/HambroPerks/myforks/prettytime/core/src/test/java/org/ocpsoft/prettytime/PrettyTimeI18n_JA_Test.java
//
...
#include "org/ocpsoft/prettytime/PrettyTimeI18n_JA_Test.h"
#include "org/ocpsoft/prettytime/TimeUnit.h"
#include "org/ocpsoft/prettytime/format/SimpleTimeFormat.h"

@implementation OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test

- (void)setUp {
  locale_ = [[JavaUtilLocale alloc] initWithNSString:@"ja"];
  [JavaUtilLocale setDefaultWithJavaUtilLocale:JavaUtilLocale_get_JAPAN_()];
}
...
- (void)testNullDate {
  ...
  [OrgJunitAssert assertEqualsWithId:@"\u4eca\u304b\u3089\u3059\u3050" withId:[t formatWithJavaUtilDate:date]];
}

- (void)testRightNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithId:@"\u4eca\u304b\u3089\u3059\u3050" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] init]]];
}
...
- (void)testRightNowVariance {
  ...
  [OrgJunitAssert assertEqualsWithId:@"\u4eca\u304b\u3089\u3059\u3050" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:600]]];
}

- (void)testMinutesFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"12 minutes from now" withId:@"\u4eca\u304b\u308912\u5206" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 12]]];
}

- (void)testHoursFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"3 hours from now" withId:@"\u4eca\u304b\u30893\u6642\u9593" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 60 * 3]]];
}

- (void)testDaysFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"3 days from now" withId:@"\u4eca\u304b\u30893\u65e5\u9593" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 60 * 24 * 3]]];
}

- (void)testWeeksFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"3 weeks from now" withId:@"\u4eca\u304b\u30893\u9031\u9593" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:1000 * 60 * 60 * 24 * 7 * 3]]];
}

- (void)testMonthsFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"3 months from now" withId:@"\u4eca\u304b\u30893\u30f6\u6708" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:2629743830LL * 3LL]]];
}

- (void)testYearsFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"3 years from now" withId:@"3\u5e74\u5f8c\u306e" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:2629743830LL * 12LL * 3LL]]];
}

- (void)testOneDecadeFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithId:@"\u4eca\u304b\u30891\u5e74\u9593" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:315569259747LL * 1LL]]];
}

- (void)testCenturiesFromNow {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"3 centuries from now" withId:@"\u4eca\u304b\u30893\u4e16\u7d00\u306b\u3082\u308f\u305f\u3063" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:3155692597470LL * 3LL]]];
}
...
- (void)testMomentsAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"\u3055\u3063\u304d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testMinutesAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"12\u5206\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testHoursAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3\u6642\u9593\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testDaysAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3\u65e5\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testWeeksAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3\u9031\u9593\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}

- (void)testOneMonthAgo {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:2629743830LL * 1LL] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithNSString:@"1 months ago" withId:@"1\u30f6\u6708\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testMonthsAgo {
  ...
  [OrgJunitAssert assertEqualsWithNSString:@"3 months ago" withId:@"3\u30f6\u6708\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}

- (void)testCustomFormat {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0] withJavaUtilLocale:locale_];
  id<OrgOcpsoftPrettytimeTimeUnit> unit = [[OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test_$1 alloc] init];
  (void) [t clearUnits];
...
- (void)testYearsAgo {
  ...
  [OrgJunitAssert assertEqualsWithId:@"3\u5e74\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}

- (void)testDecadeAgo {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:315569259747LL * 1LL] withJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithId:@"1\u5e74\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testCenturiesAgo {
  ...
  [OrgJunitAssert assertEqualsWithNSString:@"3 centuries ago" withId:@"3\u4e16\u7d00\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}

- (void)testWithinTwoHoursRounding {
  OrgOcpsoftPrettytimePrettyTime *t = [[OrgOcpsoftPrettytimePrettyTime alloc] initWithJavaUtilLocale:locale_];
  [OrgJunitAssert assertEqualsWithId:@"2\u6642\u9593\u524d" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:[((JavaUtilDate *) [[JavaUtilDate alloc] init]) getTime] - 6543990]]];
}
...
- (void)testSetLocale {
  ...
  [OrgJunitAssert assertEqualsWithId:@"vor 1 Jahrzehnt" withId:[t formatWithJavaUtilDate:[[JavaUtilDate alloc] initWithLong:0]]];
}
...
- (void)testCalendarParameter {
  ...
  [OrgJunitAssert assertEqualsWithId:@"1\u5e74\u524d" withId:[t formatWithJavaUtilCalendar:c]];
}
...
- (void)testFormatApproximateDuration {
  ...
  NSAssert([((NSString *) nil_chk(result)) isEqual:@"10\u5206"], @"org/ocpsoft/prettytime/PrettyTimeI18n_JA_Test.java:313 condition failed: assert result.equals(\"10分\");");
}
...
- (void)copyAllFieldsTo:(OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test *)other {
...
+ (IOSObjectArray *)__annotations_testOneDecadeFromNow {
  return [IOSObjectArray arrayWithObjects:(id[]) { [[OrgJunitTest alloc] initWithExpected:[[OrgJunitTest_None class] getClass] withTimeout:0] } count:1 type:[IOSClass classWithProtocol:@protocol(JavaLangAnnotationAnnotation)]];
}
...
+ (IOSObjectArray *)__annotations_testOneMonthAgo {
  return [IOSObjectArray arrayWithObjects:(id[]) { [[OrgJunitTest alloc] initWithExpected:[[OrgJunitTest_None class] getClass] withTimeout:0] } count:1 type:[IOSClass classWithProtocol:@protocol(JavaLangAnnotationAnnotation)]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "testOneDecadeFromNow", NULL, "V", 0x1, "Ljava.lang.Exception;" },
    ...
    { "testOneMonthAgo", NULL, "V", 0x1, "Ljava.lang.Exception;" },
  ...
  static J2ObjcClassInfo _OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test = { "PrettyTimeI18n_JA_Test", "org.ocpsoft.prettytime", NULL, 0x1, 31, methods, 2, fields, 0, NULL};
  return &_OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test;
}

@end

@implementation OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test_$1
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test_$1 = { "$1", "org.ocpsoft.prettytime", "PrettyTimeI18n_JA_Test", 0x8000, 3, methods, 0, NULL, 0, NULL};
  return &_OrgOcpsoftPrettytimePrettyTimeI18n_JA_Test_$1;
}
