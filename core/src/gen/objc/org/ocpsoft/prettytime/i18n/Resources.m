...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "OBJECTS", "OBJECTS", 0x1a, "[[Ljava.lang.Object;", &OrgOcpsoftPrettytimeI18nResources_OBJECTS, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources = { 2, "Resources", "org.ocpsoft.prettytime.i18n", NULL, 0x1, 2, methods, 1, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOcpsoftPrettytimeI18nResources;
}

@end

void OrgOcpsoftPrettytimeI18nResources_init(OrgOcpsoftPrettytimeI18nResources *self) {
  JavaUtilListResourceBundle_init(self);
}

OrgOcpsoftPrettytimeI18nResources *new_OrgOcpsoftPrettytimeI18nResources_init() {
  OrgOcpsoftPrettytimeI18nResources *self = [OrgOcpsoftPrettytimeI18nResources alloc];
  OrgOcpsoftPrettytimeI18nResources_init(self);
  return self;
}

OrgOcpsoftPrettytimeI18nResources *create_OrgOcpsoftPrettytimeI18nResources_init() {
  OrgOcpsoftPrettytimeI18nResources *self = [[OrgOcpsoftPrettytimeI18nResources alloc] autorelease];
  OrgOcpsoftPrettytimeI18nResources_init(self);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOcpsoftPrettytimeI18nResources)
