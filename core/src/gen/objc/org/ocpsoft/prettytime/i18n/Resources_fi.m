...
@interface OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat () {
 @public
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources_fi = { 1, "Resources_fi", "org.ocpsoft.prettytime.i18n", NULL, 0x1, 3, methods, 3, fields, 0, NULL};
...
- (instancetype)initWithJavaUtilResourceBundle:(JavaUtilResourceBundle *)rb
  ...
  if (self = [super init]) {
    ...
    if ([((JavaUtilResourceBundle *) nil_chk(bundle_)) containsKeyWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PastSingularName")]) {
      [((OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat *) nil_chk([self setPastNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PastSingularName")]])) setFutureNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"FutureSingularName")]])) setPastPluralNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PastSingularName")]])) setFuturePluralNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"FutureSingularName")]])) setPluralPatternWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"Pattern")]];
      if ([bundle_ containsKeyWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PastPluralName")]) {
        [self setPastPluralNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PastPluralName")]];
      }
      if ([bundle_ containsKeyWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"FuturePluralName")]) {
        [self setFuturePluralNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"FuturePluralName")]];
      }
      if ([bundle_ containsKeyWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PluralPattern")]) {
        [self setPluralPatternWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PluralPattern")]];
      }
      [((OrgOcpsoftPrettytimeFormatSimpleTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeFormatSimpleTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeFormatSimpleTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeFormatSimpleTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeFormatSimpleTimeFormat *) nil_chk([((OrgOcpsoftPrettytimeFormatSimpleTimeFormat *) nil_chk([self setPatternWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"Pattern")]])) setPastSuffixWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"PastSuffix")]])) setFutureSuffixWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat_getUnitNameWithOrgOcpsoftPrettytimeTimeUnit_(self, unit), @"FutureSuffix")]])) setFuturePrefixWithNSString:@""])) setPastPrefixWithNSString:@""])) setSingularNameWithNSString:@""])) setPluralNameWithNSString:@""];
    }
  }
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources_fi_FiTimeFormat = { 1, "FiTimeFormat", "org.ocpsoft.prettytime.i18n", "Resources_fi", 0xa, 15, methods, 6, fields, 0, NULL};
