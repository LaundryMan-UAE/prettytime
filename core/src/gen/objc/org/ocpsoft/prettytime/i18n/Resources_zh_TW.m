...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "OBJECTS", "OBJECTS", 0x1a, "[[Ljava.lang.Object;", &OrgOcpsoftPrettytimeI18nResources_zh_TW_OBJECTS, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources_zh_TW = { 2, "Resources_zh_TW", "org.ocpsoft.prettytime.i18n", NULL, 0x1, 2, methods, 1, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOcpsoftPrettytimeI18nResources_zh_TW;
}

@end

void OrgOcpsoftPrettytimeI18nResources_zh_TW_init(OrgOcpsoftPrettytimeI18nResources_zh_TW *self) {
  JavaUtilListResourceBundle_init(self);
}

OrgOcpsoftPrettytimeI18nResources_zh_TW *new_OrgOcpsoftPrettytimeI18nResources_zh_TW_init() {
  OrgOcpsoftPrettytimeI18nResources_zh_TW *self = [OrgOcpsoftPrettytimeI18nResources_zh_TW alloc];
  OrgOcpsoftPrettytimeI18nResources_zh_TW_init(self);
  return self;
}

OrgOcpsoftPrettytimeI18nResources_zh_TW *create_OrgOcpsoftPrettytimeI18nResources_zh_TW_init() {
  OrgOcpsoftPrettytimeI18nResources_zh_TW *self = [[OrgOcpsoftPrettytimeI18nResources_zh_TW alloc] autorelease];
  OrgOcpsoftPrettytimeI18nResources_zh_TW_init(self);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOcpsoftPrettytimeI18nResources_zh_TW)
