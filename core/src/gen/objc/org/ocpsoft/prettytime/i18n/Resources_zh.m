...
//  source: /Users/andrefonseca/Documents/PodsFolders/prettytime/core/src/main/java/org/ocpsoft/prettytime/i18n/Resources_zh.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "OBJECTS", "OBJECTS", 0x1a, "[[Ljava.lang.Object;", &OrgOcpsoftPrettytimeI18nResources_zh_OBJECTS, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources_zh = { 2, "Resources_zh", "org.ocpsoft.prettytime.i18n", NULL, 0x1, 2, methods, 1, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOcpsoftPrettytimeI18nResources_zh;
}

@end

void OrgOcpsoftPrettytimeI18nResources_zh_init(OrgOcpsoftPrettytimeI18nResources_zh *self) {
  JavaUtilListResourceBundle_init(self);
}

OrgOcpsoftPrettytimeI18nResources_zh *new_OrgOcpsoftPrettytimeI18nResources_zh_init() {
  OrgOcpsoftPrettytimeI18nResources_zh *self = [OrgOcpsoftPrettytimeI18nResources_zh alloc];
  OrgOcpsoftPrettytimeI18nResources_zh_init(self);
  return self;
}

OrgOcpsoftPrettytimeI18nResources_zh *create_OrgOcpsoftPrettytimeI18nResources_zh_init() {
  OrgOcpsoftPrettytimeI18nResources_zh *self = [[OrgOcpsoftPrettytimeI18nResources_zh alloc] autorelease];
  OrgOcpsoftPrettytimeI18nResources_zh_init(self);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOcpsoftPrettytimeI18nResources_zh)
