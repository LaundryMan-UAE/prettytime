...
inline IOSObjectArray *OrgOcpsoftPrettytimeI18nResources_da_get_OBJECTS();
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "OBJECTS", "OBJECTS", 0x1a, "[[Ljava.lang.Object;", &OrgOcpsoftPrettytimeI18nResources_da_OBJECTS, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources_da = { 2, "Resources_da", "org.ocpsoft.prettytime.i18n", NULL, 0x1, 2, methods, 1, fields, 0, NULL, 0, NULL, NULL, NULL };
...
OrgOcpsoftPrettytimeI18nResources_da *new_OrgOcpsoftPrettytimeI18nResources_da_init() {
  OrgOcpsoftPrettytimeI18nResources_da *self = [OrgOcpsoftPrettytimeI18nResources_da alloc];
  OrgOcpsoftPrettytimeI18nResources_da_init(self);
  return self;
}

OrgOcpsoftPrettytimeI18nResources_da *create_OrgOcpsoftPrettytimeI18nResources_da_init() {
  OrgOcpsoftPrettytimeI18nResources_da *self = [[OrgOcpsoftPrettytimeI18nResources_da alloc] autorelease];
  OrgOcpsoftPrettytimeI18nResources_da_init(self);
  return self;
}
