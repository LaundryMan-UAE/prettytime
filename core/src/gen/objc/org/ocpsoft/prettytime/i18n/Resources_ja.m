...
inline IOSObjectArray *OrgOcpsoftPrettytimeI18nResources_ja_get_OBJECTS();
...
inline NSString *OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_get_NEGATIVE();
...
inline NSString *OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_get_SIGN();
...
inline NSString *OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_get_QUANTITY();
...
inline NSString *OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_get_UNIT();
...
NSString *OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_applyPatternWithNSString_withNSString_withLong_(OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat *self, NSString *sign, NSString *unit, jlong quantity) {
  NSString *result = [((NSString *) nil_chk([self getPatternWithLong:quantity])) replaceAll:OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_SIGN withReplacement:sign];
  result = [((NSString *) nil_chk(result)) replaceAll:OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_QUANTITY withReplacement:NSString_valueOfLong_(quantity)];
  result = [((NSString *) nil_chk(result)) replaceAll:OrgOcpsoftPrettytimeI18nResources_ja_JaTimeFormat_UNIT withReplacement:unit];
  return result;
}
