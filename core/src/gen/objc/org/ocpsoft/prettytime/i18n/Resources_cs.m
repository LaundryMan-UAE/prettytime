...
//  source: /Users/Mike/Projects/prettytime/core/src/main/java/org/ocpsoft/prettytime/i18n/Resources_cs.java
//
...
- (id<OrgOcpsoftPrettytimeTimeFormat>)getFormatForWithOrgOcpsoftPrettytimeTimeUnit:(id<OrgOcpsoftPrettytimeTimeUnit>)t {
  if ([t isKindOfClass:[OrgOcpsoftPrettytimeUnitsMinute class]]) {
    ...
    return [((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) [[[OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder alloc] initWithNSString:@"Day"] autorelease]) addFutureNameWithNSString:@"den" withLong:1])) addFutureNameWithNSString:@"dny" withLong:4])) addFutureNameWithNSString:@"dn\u221a\u2260" withLong:JavaLangLong_MAX_VALUE])) addPastNameWithNSString:@"dnem" withLong:1])) addPastNameWithNSString:@"dny" withLong:JavaLangLong_MAX_VALUE])) buildWithJavaUtilResourceBundle:self];
  }
  else if ([t isKindOfClass:[OrgOcpsoftPrettytimeUnitsWeek class]]) {
    return [((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) [[[OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder alloc] initWithNSString:@"Week"] autorelease]) addFutureNameWithNSString:@"t\u221a\u03a9den" withLong:1])) addFutureNameWithNSString:@"t\u221a\u03a9dny" withLong:4])) addFutureNameWithNSString:@"t\u221a\u03a9dn\u2248\u00d8" withLong:JavaLangLong_MAX_VALUE])) addPastNameWithNSString:@"t\u221a\u03a9dnem" withLong:1])) addPastNameWithNSString:@"t\u221a\u03a9dny" withLong:JavaLangLong_MAX_VALUE])) buildWithJavaUtilResourceBundle:self];
  }
  else if ([t isKindOfClass:[OrgOcpsoftPrettytimeUnitsMonth class]]) {
    return [((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) nil_chk([((OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder *) [[[OrgOcpsoftPrettytimeI18nResources_cs_CsTimeFormatBuilder alloc] initWithNSString:@"Month"] autorelease]) addFutureNameWithNSString:@"m\u0192\u00f5s\u221a\u2260c" withLong:1])) addFutureNameWithNSString:@"m\u0192\u00f5s\u221a\u2260ce" withLong:4])) addFutureNameWithNSString:@"m\u0192\u00f5s\u221a\u2260c\u2248\u00d8" withLong:JavaLangLong_MAX_VALUE])) addPastNameWithNSString:@"m\u0192\u00f5s\u221a\u2260cem" withLong:1])) addPastNameWithNSString:@"m\u0192\u00f5s\u221a\u2260ci" withLong:JavaLangLong_MAX_VALUE])) buildWithJavaUtilResourceBundle:self];
  }
