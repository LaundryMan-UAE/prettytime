...
inline IOSObjectArray *OrgOcpsoftPrettytimeI18nResources_nl_get_OBJECTS();
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "OBJECTS", "OBJECTS", 0x1a, "[[Ljava.lang.Object;", &OrgOcpsoftPrettytimeI18nResources_nl_OBJECTS, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _OrgOcpsoftPrettytimeI18nResources_nl = { 2, "Resources_nl", "org.ocpsoft.prettytime.i18n", NULL, 0x1, 2, methods, 1, fields, 0, NULL, 0, NULL, NULL, NULL };
...
OrgOcpsoftPrettytimeI18nResources_nl *new_OrgOcpsoftPrettytimeI18nResources_nl_init() {
  OrgOcpsoftPrettytimeI18nResources_nl *self = [OrgOcpsoftPrettytimeI18nResources_nl alloc];
  OrgOcpsoftPrettytimeI18nResources_nl_init(self);
  return self;
}

OrgOcpsoftPrettytimeI18nResources_nl *create_OrgOcpsoftPrettytimeI18nResources_nl_init() {
  OrgOcpsoftPrettytimeI18nResources_nl *self = [[OrgOcpsoftPrettytimeI18nResources_nl alloc] autorelease];
  OrgOcpsoftPrettytimeI18nResources_nl_init(self);
  return self;
}
