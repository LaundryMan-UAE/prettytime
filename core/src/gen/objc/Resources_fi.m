  ...
  if (self = [super init]) {
    ...
    if ([((JavaUtilResourceBundle *) nil_chk(bundle_)) containsKeyWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"PastSingularName")]) {
      ...
      if ([bundle_ containsKeyWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"PastPluralName")]) {
        (void) [self setPastPluralNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"PastPluralName")]];
      }
      if ([bundle_ containsKeyWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"FuturePluralName")]) {
        (void) [self setFuturePluralNameWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"FuturePluralName")]];
      }
      if ([bundle_ containsKeyWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"PluralPattern")]) {
        (void) [self setPluralPatternWithNSString:[bundle_ getStringWithNSString:JreStrcat("$$", [self getUnitNameWithOrgOcpsoftPrettytimeTimeUnit:unit], @"PluralPattern")]];
      }
